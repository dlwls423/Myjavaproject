...
public class Parser {
    ...
    public Parser parseFirstNum(String firstInput) throws BadInputException {
        // 구현 1.
        if(!Pattern.matches(NUMBER_REG, firstInput)) throw new BadInputException("정수");
    ...
    public Parser parseSecondNum(String secondInput) throws BadInputException{
        // 구현 1.
        if(!Pattern.matches(NUMBER_REG, secondInput)) throw new BadInputException("정수");
    ...
    public Parser parseOperator(String operationInput) throws BadInputException {
        // 구현 1.
        if(!Pattern.matches(OPERATION_REG, operationInput)) throw new BadInputException("연산자");
